...
class PDA(Generic[ET]):  # Probabilistic Data Association
    ...
    def gate(
        ...
        *,
        ...
        gated =  list(map(lambda z : self.state_filter.gate(z, filter_state, g_squared, sensor_state=sensor_state), Z))# TODO: some for loop over elements of Z using self.state_filter.gate
        return gated
    ...
    def loglikelihood_ratios(
        ...
        *,
        ...
        ll[1:] = [log_PD + self.state_filter.loglikelihood(z, filter_state, sensor_state) for z in Z]# TODO: some for loop over elements of Z using self.state_filter.loglikelihood
    ...
    def association_probabilities(
        ...
        *,
        ...
        # probabilities
        beta = np.exp(lls) / np.sum(np.exp(lls)) # TODO
        return beta
    ...
    def conditional_update(
        ...
        *,
        ...
        conditional_update.extend(
            ...
            [
                self.state_filter.update(z, filter_state, sensor_state)
                for z in Z
            ]
        )
